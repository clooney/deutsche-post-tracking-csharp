# Deutsche Post Tracking API For Csharp
Deutsche Post Tracking API and webhook make it easy to integrate Deutsche Post Tracking function into your own project. Support APIs Client Libraries for csharp

### API key

In order to use this API, you need to generate a Deutsche Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Deutsche Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Deutsche Post Tracking API](https://www.trackingmore.com/deutsche-post-tracking.html)  to:

   *   Get Deutsche Post realtime tracking info of muti-carriers in one integration
   *   Provide Deutsche Post shipment tracking experience like Amazon
   *   Push Deutsche Post notifications of package update with webhook
   *   Verify Deutsche Post delivery exception before it is too late
